    ...
    function CargarTabla()
      	{
	        $("#datos").empty();
	        $.ajax({
			url: '../controllers/ComprasTablaJSON.php',
			type: 'POST',
			dataType: 'JSON',
			timeout: 100000,
			beforeSend: function(){
			...
			success: function(resultado){
			    ...
			    $.each(resultado,function(index,contenido)
					{
						$("#datos").append('<tr><td align="center">'+contenido['idconfirmacion']+'</td><td align="center">'+contenido['nombre']+'</td><td align="center">'+contenido['nro_factura']+'</td><td align="center">'+contenido['nro_control']+'</td><td align="center">'+contenido['cantidad']+'</td><td align="center">'+contenido['total_iva']+'</td><td align="center">'+contenido['sub_total']+'</td><td align="center">'+contenido['total']+'</td><td align="center">'+contenido['fecha']+'</td><td width="10%"><button class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></button> <button class="btn btn-danger" href="javascript:void(0);" data-toggle="modal" data-target="#ModalEliminar" onclick="ModalEliminar('+contenido['id']+');"><i class="fa fa-trash" aria-hidden="true"></i></button></td></tr>');
					});			    
			    }
			})
      	}
